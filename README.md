...
| 20 Aug, 2025 | 1. Remove unnecessary columns in ArcGIS and re-export the GeoJSON file<br>2. Add the underserved neighbourhood layer<br>3. Update the popup information<br>4. Slightly reduce zoom level under mobile view | （；´д｀）ゞ done |
| Aug 25|ready to go|🤞
