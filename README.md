...
| Aug 18|1. Remove unnecessary columns in ArcGIS and re-export the GeoJSON file 2. Add the underserved neighbourhood layer 3. Update the popup information| （；´д｀）ゞ done
| Aug 25|ready to go|🤞
